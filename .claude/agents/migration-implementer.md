...
5. Run the checks often: `php artisan test --compact <file>` for the files you touched, `pnpm exec vue-tsc --noEmit` when you touch TS/Vue, and `vendor/bin/pint --dirty --format agent` before finishing.
